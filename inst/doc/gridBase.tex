...
\usepackage{/home/rdev/paul/Research/Rstuff/r-devel/R/share/texmf/Sweave}
\begin{document}
\maketitle
...
> push.viewport(vps$inner, vps$figure, vps$plot)
> for (i in 1:25) {
+     push.viewport(viewport(x = unit(chinasea$lat[i], "native"), 
...
+     push.viewport(viewport(y = space, width = 0.9, height = unit(0.9, 
